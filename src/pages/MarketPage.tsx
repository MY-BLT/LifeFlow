...
const personas = [
  {
    ...
    tools: ['Notion', 'Jira', 'Spotify (موسیقی کار)'],
    ...
    <div style={{ minHeight: '100vh', background: '#0d1117', paddingTop: '80px' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          <span className="badge badge-blue" style={{ marginBottom: '16px', display: 'inline-flex' }}>تحلیل بازار</span>
          ...
          <p style={{ fontSize: '16px', color: '#8b949e', maxWidth: '600px', margin: '0 auto' }}>
            بازار جهانی productivity tools در حال انفجار است. ایران سهم خود را می‌طلبد.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px', marginBottom: '40px' }}>
          {[
            { label: 'بازار جهانی', value: '$۱۲۰B', sub: 'Productivity Software 2025', color: '#58a6ff', icon: '🌍' },
            { label: 'بازار MENA', value: '$۲۸۰M', sub: 'نرخ رشد سالانه ۲۳٪', color: '#3fb950', icon: '🌏' },
            { label: 'بازار ایران', value: '$۴۵M', sub: 'بازار هدف اولیه', color: '#bc8cff', icon: '🇮🇷' },
            { label: 'کاربران بالقوه', value: '۸M+', sub: 'متخصصان ایرانی', color: '#d29922', icon: '👥' },
          ].map((item, i) => (
        ...
        <div className="card" style={{ marginBottom: '32px', padding: '32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {[
              { segment: 'متخصصان آزاد (فریلنسرها)', size: '۱.۲M نفر', potential: '۸۵٪', color: '#58a6ff', desc: 'بالاترین انگیزه برای بهبود بهره‌وری شخصی، پرداخت مستقیم' },
              { segment: 'تیم‌های استارتاپ (۵-۵۰ نفر)', size: '۸۵۰K نفر', potential: '۷۸٪', color: '#3fb950', desc: 'نیاز به داشبورد سازمانی، پرداخت توسط شرکت' },
              { segment: 'شرکت‌های متوسط (۵۰-۵۰۰ نفر)', size: '۴۲۰K نفر', potential: '۶۵٪', color: '#bc8cff', desc: 'چرخه فروش طولانی‌تر اما ARR بالاتر' },
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
            {[
              { title: 'نقاط قوت (S)', items: ['هوش مصنوعی اختصاصی بهره‌وری', 'رابط فارسی بومی‌سازی‌شده', 'حریم خصوصی محلی', 'قیمت رقابتی منطقه‌ای', 'داشبورد دوگانه شخصی/سازمانی'], color: '#3fb950' },
              { title: 'نقاط ضعف (W)', items: ['عدم شناخت برند در ابتدا', 'وابستگی به داده کاربر', 'نیاز به آموزش کاربران', 'منابع محدود اولیه'], color: '#f85149' },
              { title: 'فرصت‌ها (O)', items: ['بازار بکر در ایران', 'رشد دورکاری پس از کرونا', 'افزایش آگاهی بهره‌وری', 'اکوسیستم استارتاپی رو‌به‌رشد'], color: '#58a6ff' },
              { title: 'تهدیدها (T)', items: ['ورود رقبای خارجی به بازار', 'تغییرات قوانین داده‌ها', 'رقابت با ابزارهای رایگان', 'نوسانات اقتصادی'], color: '#d29922' },
            ].map((q, i) => (
              <div key={i} style={{
